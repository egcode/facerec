...
def parse_arguments(argv):
    ...
    parser.add_argument('--model_type', type=str, help='Model type to use for training.', default='ResNet_50')# support: ['LightNet', 'MobileNet_V2', 'MobileNet_V3_Small', 'MobileNet_V3_Large', 'ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152']
